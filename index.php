            ...
            <div id="form">
                <form id="frmSearch" class="search-form" action="go.php" method="get" accept-charset="UTF-8">
                    <input
							type="text"
							id="txtSearch"
							name="q" alt="Search Criteria"
							oninput="triggerSuggestLater('de')"
							autocomplete="off"
							placeholder="Finde Wissen aus 3,1 Mio. Artikeln"
							aria-placeholder="Finde Wissen aus 3,1 Mio. Artikeln"
							aria-label="Wikipedia durchsuchen"
					/>
