...
ini_set('user_agent', 'wikipedia.de (fetching featured content)'); # define user agent used with wikibox functionality
...
$wbWikiUrl = "https://wiki.wikimedia.de/w/index.php"; # index.php URI of (remote) mediawiki installation

$wbCachePrefix = "wpde-"; # filename prefix for cache files

if ( function_exists('apc_store') ) {
	$wbInternalCacheMode = 'apc'; //may be auto, apc, xcache or eaccellerator; use false to disable
} else {
	$wbInternalCacheMode = null;
}

$wbMemcachedServer = "localhost:11211"; // use memcached for buffering cached content; has no effect if $wbInternalCacheMode is set.
$wbCacheBufferDuration = 20; // check files every 20 seconds 

$wbFeatureListPage = "Web:Features"; # list of features to be displayed
$wbBannerListPage = "Web:Banner"; # list of banners to be displayed

$piwikConf = array(
	"active" => false,
	"url" => "http://spenden.wikimedia.de/piwik/", # URI of piwik installation
	"secureUrl" => "https://spenden.wikimedia.de/piwik/", # secure URI of piwik installation
	"siteId" => "3", # site ID as defined in piwik
);
